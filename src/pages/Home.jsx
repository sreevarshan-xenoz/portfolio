          ...
          <Grid container spacing={4} sx={{ perspective: '1000px' }}>
            {[
              ...
              },
              {
                ...
                longDescription: "AURA is a comprehensive smart home system that allows for control of all connected devices through voice commands and gesture recognition. It features a sleek dashboard, automated routines, and integration with popular smart home standards. The system learns from your behaviors to suggest optimizations for energy efficiency and convenience.",
                tech: ["IoT", "React", "Node.js", "Machine Learning"],
              ...
              },
              {
                ...
                longDescription: "DocApp is a telehealth platform that makes healthcare more accessible by enabling virtual consultations with medical professionals. The system includes AI-assisted pre-screening, secure video conferencing, digital prescription management, and integration with insurance providers. It also features a symptom checker and personalized health recommendations.",
                tech: ["React Native", "Firebase", "TensorFlow", "WebRTC"],
                image: "/project images/doc app.png",
                color: '#ff64b4',
                category: "Web Apps",
                status: "Completed",
                github: "https://github.com/sreevarshan-xenoz/docapp",
                featured: true
              },
              {
                title: "SwiftPick",
                ...
                longDescription: "SwiftPick utilizes collaborative filtering and content-based recommendation algorithms to provide highly relevant product suggestions to online shoppers. The system analyzes browsing history, purchase patterns, and demographic data to create a tailored shopping experience that increases conversion rates and customer satisfaction.",
                tech: ["Python", "React", "TensorFlow", "AWS"],
                image: "/project images/swiftpick.png",
                color: '#FFB400',
                category: "AI/ML",
                status: "Active",
                github: "https://github.com/sreevarshan-xenoz/swiftpick",
                featured: true
              },
              {
                ...
                longDescription: "Student Job Finder is designed specifically for college students seeking employment that accommodates their academic schedules. The platform features location-based job searches, skill matching algorithms, and integration with university career services. Employers can post positions targeted at specific majors or skill sets.",
